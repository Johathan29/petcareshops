    ...
    <section>
            ...
            <div class="">
                <div class=" flex gap-12 w-full  p-5  rounded-lg border-2 border-[#e5e7eb6b] " style="">
                    <div class="brightness-50">
                        <h1 class="capitalize text-white text-[1.5rem] flex items-center gap-1">
                            {{ userregistered.firstName }}<div
                                :class="['h-2 w-2 rounded-full relative ', userregistered.role === 'admin' ? 'bg-green-500' : 'bg-red-500', 'me-4']">
                            </div>
                        </h1>
        ...
        <div class="max-w-screen-xl md:mx-auto px-5 relative bottom-[33rem]">
            <button data-modal-target="authentication-modal" data-modal-toggle="authentication-modal"
                class="block text-white top-[10rem] right-[2rem]  hover:bg-blue-800 focus:outline-none hover:opacity-[1] opacity-[0.3] font-medium hover:bg-transparent rounded-lg text-sm   text-center  absolute"
                type="button">
                            ...
                            <form class="space-y-4" action="#">
                                <div>
                                    ...
                                    <label for="name"
                                        ...
                                        name</label>
                                    <input name="firstname" @input="event => firstname = event.target.value"
                                ...
                                <button type="button"
                                    ...
                                    @click="update(datos.Id, firstname)">Login to your account</button>
