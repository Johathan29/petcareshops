...
const portada = [
  {
    id: 1,
    title: 'Comprehensive Care for Your Best Frien',
    nombre:"Tobi",
    description:"Book your next appointment with ease and keep track of your pet's health records all in one place.",
    estado:'Surgery',
    type:'cats',
    raza:'Siamese cat',
    sexo:'M',
...
export default {
  nombre: 'Data',
  value: [portada,animals,diseases,services],
};
