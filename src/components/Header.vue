        ...
        <div class="flex items-center gap-8">
          <router-link to="/" class="flex items-center gap-3 group">
           ...
           <div class="leading-[.5] text-justify">
              <h2 class="text-xl font-bold tracking-tight text-slate-900 dark:text-white hover:text-[#0a19bc]"> PetCare </h2>
...
<router-link
  v-else
  to="/auth"
  class="px-4 py-2 rounded-lg bg-primary text-white font-bold text-sm"
>
  Login
</router-link>
    ...
    <ul class="p-2 text-sm font-medium">
      ...
      <li>
        ...
        >
          ...
          <!-- MOBILE BUTTON -->
          <button
            class="lg:hidden p-2 text-slate-600 hover:text-primary transition-transform duration-300"
            @click="openNav"
...
>
  ...
  <div
    v-if="user && isUserMenuOpen"
    class=" z-50 bg-white dark:bg-slate-900
           border border-slate-200 dark:border-slate-800
           rounded-lg shadow-md w-44"
  >
    <ul class="p-2 text-sm font-medium">
