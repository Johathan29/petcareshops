...
<template>
  <div ref="cardRef" :class="[
    ...
    <div class="size-20 shrink-0 rounded-lg overflow-hidden relative z-10">
      <img :src="pet.imagen" :alt="pet.nombre" :class="[
    ...
    <!-- Actions -->
    <div class="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-all duration-300 text-white z-10">
      <button @click.stop="!isAdopted && emit('edit', pet)" :disabled="isAdopted" :class="[
