...
<span
        ...
        <div class="relative group">
          <button
            class="size-8 rounded-lg bg-[#eff6ff] text-primary
          ...
          <div
            class="absolute right-0 top-10 w-48 p-3 bg-zinc-900 text-white text-xs
...
>
  ...
  <!-- Arrow -->
  <span
    class="absolute left-1/2 top-[1.2rem] -translate-x-1/2
           w-2 h-2 rotate-45"
    :class="value.hour === null
      ? 'bg-red-600'
      : isToday(value.day)
