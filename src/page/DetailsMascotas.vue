    ...
    <div class="flex flex-col max-w-screen-xl md:mx-auto px-[1.5rem] md:px-[3.5rem] gap-6">
      <div class="flex flex-col gap-4">
        ...
        <div class="flex flex-wrap justify-between items-end gap-4">
          <h1 class="text-text-main-light dark:text-text-main-dark text-3xl  font-bold leading-tight tracking-tight">Pet
            Details: {{ pet?.nombre }}</h1>
          <div class="block items-center justify-end md:flex gap-3 ">
            <button
              class="px-3 py-2.5 rounded-lg  w-[13rem] border border-border-light dark:border-border-dark bg-white dark:bg-card-dark text-text-main-light dark:text-text-main-dark text-sm font-semibold hover:bg-gray-50 dark:hover:bg-white/5 transition-colors flex items-center justify-center gap-2">
              <span class="material-symbols-outlined text-[18px]">print</span>
              Print Record
            </button>
            <button title="Adoptar mascota" class=" w-[14rem] py-2.5 px-3 rounded-lg flex items-center gap-2 justify-center
         bg-[#0F6CBD] text-white font-bold text-[14px]
         hover:bg-[#0c5aa3] transition
         active:scale-95" @click.prevent="userAuthed ? openAdoptionModal(pet) : openMessageModal()">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        <div class="lg:col-span-4 flex flex-col gap-6">
          <div
            ...
            <div class="flex items-center gap-2 mb-6">
              <span
                class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400">
                <span class="w-2 h-2 rounded-full bg-green-500"></span>
                Active
              </span>
              <span
                class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400">
                <span class="material-symbols-outlined text-[14px]">
                  <template v-if="pet?.genero === 'Male'">
                    <svg viewBox="0 0 24 24" width="20px" fill="none" xmlns="http://www.w3.org/2000/svg"
                      stroke="#0a19bc" stroke-width="0.00024000000000000003">
                      <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                      <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                      <g id="SVGRepo_iconCarrier">
                  ...
                  <template v-else>
                    <svg fill="#0a19bc" height="24px" width="20px" version="1.1" id="Layer_1"
                      xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                      viewBox="0 0 512.002 512.002" xml:space="preserve" stroke="#0a19bc"
                      stroke-width="0.005120019999999999">
                      <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                      <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                      <g id="SVGRepo_iconCarrier">
                        <g>
            ...
            <div class="w-full grid grid-cols-2 gap-3 border-t border-border-light dark:border-border-dark pt-6">
              <div class="flex flex-col">
                <span
                  class="text-xs text-text-sec-light dark:text-text-sec-dark font-medium uppercase tracking-wider">Weight</span>
              ...
              <div class="flex flex-col border-l border-border-light dark:border-border-dark">
                <span
                  class="text-xs text-text-sec-light dark:text-text-sec-dark font-medium uppercase tracking-wider">Reg.
                  ID</span>
          ...
          <div
            ...
            <div class="flex items-center justify-between mb-4">
              <h3 class="text-sm font-bold uppercase tracking-wider text-text-sec-light dark:text-text-sec-dark">Owner
              </h3>
              <a class="text-xs font-bold text-[] hover:underline" href="#">View Profile</a>
            </div>
            <div class="flex items-center gap-4">
              <div
                class="size-12 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center text-gray-500 dark:text-gray-400">
        ...
        <div class="lg:col-span-8 flex flex-col gap-6">
          <div
            class="bg-card-light dark:bg-card-dark rounded-xl shadow-sm border border-border-light dark:border-border-dark p-6 md:p-8">
            <h3 class="text-xl font-bold text-text-main-light dark:text-text-main-dark mb-6 flex items-center gap-2">
              <span class="material-symbols-outlined text-primary"><svg viewBox="0 0 24 24" width="24px" fill="none"
                  xmlns="http://www.w3.org/2000/svg" stroke="#ffffff">
                  <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                  <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                  <g id="SVGRepo_iconCarrier">
                    <circle cx="12" cy="12" r="10" stroke="#0a19bcad" stroke-width="1.5"></circle>
                    <path d="M12 17V11" stroke="#0a19bcad" stroke-width="1.5" stroke-linecap="round"></path>
                    <circle cx="1" cy="1" r="1" transform="matrix(1 0 0 -1 11 9)" fill="#0a19bcad"></circle>
                  </g>
                </svg></span>
              General Information
            </h3>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-8 gap-x-6">
              <div class="flex flex-col gap-1">
                <span class="text-xs font-bold text-text-sec-light dark:text-text-sec-dark uppercase tracking-wide">Pet
                  Name</span>
                <span class="text-base font-medium text-text-main-light dark:text-text-main-dark">{{ pet?.nombre
                  }}</span>
              </div>
              <div class="flex flex-col gap-1">
                <span
                  class="text-xs font-bold text-text-sec-light dark:text-text-sec-dark uppercase tracking-wide">Species</span>
                <span class="text-base font-medium text-text-main-light dark:text-text-main-dark ">
                  <span class="material-symbols-outlined text-sm">{{ pet?.especie === 'cat' ? ('pets') :
    pet?.especie === 'dog' ? ('sound_detection_dog_barking') : pet?.especie === "bird" ? ('raven') : ""
                    }}</span>
                  {{ pet?.especie }}
                </span>
              </div>
              <div class="flex flex-col gap-1">
                <span
                  class="text-xs font-bold text-text-sec-light dark:text-text-sec-dark uppercase tracking-wide">Breed</span>
                <span class="text-base font-medium text-text-main-light dark:text-text-main-dark">{{ pet?.raza }}</span>
              </div>
              <div class="flex flex-col gap-1">
                <span
                  class="text-xs font-bold text-text-sec-light dark:text-text-sec-dark uppercase tracking-wide">Color</span>
                <span
                  class="text-base font-medium text-text-main-light dark:text-text-main-dark flex items-center gap-2 justify-center">
                  <div class="w-3 h-3 rounded-full bg-[#E5C76B] border border-gray-200"></div> Golden / Cream
                </span>
              </div>
              <div class="flex flex-col gap-1">
                <span class="text-xs font-bold text-text-sec-light dark:text-text-sec-dark uppercase tracking-wide">Date
                  of
                  Birth</span>
                <span class="text-base font-medium text-text-main-light dark:text-text-main-dark">{{ pet?.nacimiento
                  }}</span>
              </div>
              <div class="flex flex-col gap-1">
                <span
                  class="text-xs font-bold text-text-sec-light dark:text-text-sec-dark uppercase tracking-wide">Microchip
                  ID</span>
                <span
                  class="text-base font-medium text-text-main-light dark:text-text-main-dark font-mono">985-120-334-11</span>
              </div>
            </div>
          </div>
          <div
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              <div
                class="bg-input-bg-light dark:bg-input-bg-dark rounded-lg p-5 border border-border-light dark:border-border-dark">
                <div class="flex items-center justify-between mb-3">
                  <span class="text-sm font-bold text-text-main-light dark:text-text-main-dark">Vaccination
                    Status</span>
                  <span
                    class="inline-flex items-center gap-1 px-2 py-0.5 rounded text-xs font-bold bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400 border border-green-200 dark:border-green-800">
                ...
                <div class="space-y-3">
                  <div class="flex justify-between items-center text-sm">
                    ...
                    <span class="text-text-main-light dark:text-text-main-dark font-medium">{{ pet?.fechaInyecion
                      }}</span>
                  </div>
                  <div class="flex justify-between items-center text-sm">
                    <span class="text-text-sec-light dark:text-text-sec-dark">Rabies</span>
                    <span class="text-text-main-light dark:text-text-main-dark font-medium">Expires:
                      {{ petExpiredDate }}</span>
                  </div>
                  <div class="flex justify-between items-center text-sm">
              ...
              <div
                class="bg-input-bg-light dark:bg-input-bg-dark rounded-lg p-5 border border-border-light dark:border-border-dark">
                <span class="text-sm font-bold text-text-main-light dark:text-text-main-dark block mb-3">Primary
                  Veterinarian</span>
                <div class="flex items-start gap-3">
                  <div
                    class="size-10 rounded-full bg-primary/20 flex items-center justify-center text-primary shrink-0">
            ...
            <div class="flex flex-col gap-2">
              <span
                class="text-xs font-bold text-text-sec-light dark:text-text-sec-dark uppercase tracking-wide">Medical
                Notes
                &amp; Alerts</span>
              <div
                class="bg-yellow-50 dark:bg-yellow-900/10 border border-yellow-200 dark:border-yellow-900/30 rounded-lg p-4 flex gap-3">
                <span class="material-symbols-outlined text-yellow-600 dark:text-yellow-500 shrink-0">warning</span>
                <div>
                  <p class="text-sm font-bold text-text-main-light dark:text-text-main-dark mb-1">Allergies &amp;
                    Sensitivities
                  </p>
                  <p class="text-sm text-text-main-light dark:text-text-main-dark">Allergic to chicken. Shows signs of
                    itching
                    and digestive issues. Please ensure all treats and food are chicken-free.</p>
                </div>
              </div>
              <div class="mt-2 text-sm text-text-main-light dark:text-text-main-dark pl-1">
                <p><span class="font-bold">Instructions:</span> Needs monthly flea prevention on the 1st of every month.
                </p>
              </div>
            </div>
          </div>
